...
function importPcProgrammingV165(){
  ...
  const marker=`forgelabMobileProgrammingImport:v1122:${currentUser.id}`;
...
async function repairSeriesFromCarnet(cloudRows){
  // v1.12.2 : fonction conservée uniquement pour compatibilité interne.
...
function jSeriesBaselineForDraft(id){
  ...
  // Compatibilité immédiate avec les séances déjà validées avant v1.12.2 :
...
function showAuth(message=''){
  ...
  box.innerHTML=`<main class="auth-screen"><section class="auth-shell">
    <div class="auth-identity">
      <img class="auth-laurel" src="auth-laurel-realistic-v1122.png" alt="" aria-hidden="true">
      <div class="auth-brand">FORGELAB</div>
      <div class="auth-sub">ATLAS · ESPACE PERSONNEL</div>
      <div class="auth-version"><span>v1.12.2</span></div>
    </div>
...
function trackingMuscuSummary(){
  ...
  return `<section class="track-muscu-recap story-recap ${complete?'week-complete':''}">
    <div class="story-forgelab-brand"><img src="auth-laurel-realistic-v1122.png" alt=""><strong>ForgeLab</strong></div>
...
// v1.12.2 : aucun nettoyage automatique de Séries.
