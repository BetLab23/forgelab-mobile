const CACHE='forgelab-shell-v1251';
const ASSETS=['./','./index.html','./mobile.v1225.css?build=1251','./mobile.v1251.js?build=1251','./manifest.v1225.webmanifest?build=1251','./auth-laurel-realistic-v1225.png?build=1251'];
