...
function showAuth(message=''){
  ...
  box.innerHTML=`<main class="auth-screen"><section class="auth-shell">
    <div class="auth-identity">
      <img class="auth-laurel" src="auth-laurel-realistic-v1175.png" alt="" aria-hidden="true">
...
async function generateProgramImage(){
 ...
 let ref=null,laurel=null,footerScene=null,posterRef=null;try{ref=await load('template-reference-v1175.png')}catch(_){ }try{laurel=await load('auth-laurel-realistic-v1175.png')}catch(_){ }try{footerScene=await load('footer-mountains-man-v1175.png')}catch(_){ }try{posterRef=await load('poster-reference-v1175.png')}catch(_){ }
 const atlasFiles={pectoraux:'atlas-pectoraux-v1175.png',dos:'atlas-dos-v1175.png',deltoide_anterieur:'atlas-deltoide_anterieur-v1175.png',deltoide_lateral:'atlas-deltoide_lateral-v1175.png',deltoide_posterieur:'atlas-deltoide_posterieur-v1175.png',trapezes_superieurs:'atlas-trapezes_superieurs-v1175.png',trapezes_moyens:'atlas-trapezes_moyens-v1175.png',cou:'atlas-cou-v1175.png',biceps:'atlas-biceps-v1175.png',triceps:'atlas-triceps-v1175.png',avant_bras:'atlas-avant_bras-v1175.png',abdominaux:'atlas-abdominaux-v1175.png',lombaires:'atlas-lombaires-v1175.png',fessiers:'atlas-fessiers-v1175.png',adducteurs:'atlas-adducteurs-v1175.png',quadriceps:'atlas-quadriceps-v1175.png',ischios:'atlas-ischios-v1175.png',mollets:'atlas-mollets-v1175.png'};
...
function trackingMuscuSummary(){
  ...
  return `<section class="track-muscu-recap story-recap ${complete?'week-complete':''}">
    <div class="story-forgelab-brand"><img src="auth-laurel-realistic-v1175.png" alt=""><strong>ForgeLab</strong></div>
