...
function showAuth(message=''){
  ...
  box.innerHTML=`<main class="auth-screen"><section class="auth-shell">
    <div class="auth-identity">
      <img class="auth-laurel" src="auth-laurel-realistic-v1136.png" alt="" aria-hidden="true">
...
async function generateProgramImage(){
 ...
 let ref=null,laurel=null,footerScene=null;try{ref=await load('template-reference-v1136.png')}catch(_){ }try{laurel=await load('auth-laurel-realistic-v1136.png')}catch(_){ }try{footerScene=await load('footer-mountains-man-v1136.png')}catch(_){ }
 ...
 // Footer v1.13.6 : une seule scène continue, sans raccord ni inscription.
...
function trackingMuscuSummary(){
  ...
  return `<section class="track-muscu-recap story-recap ${complete?'week-complete':''}">
    <div class="story-forgelab-brand"><img src="auth-laurel-realistic-v1136.png" alt=""><strong>ForgeLab</strong></div>
