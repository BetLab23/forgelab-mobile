...
function showAuth(message=''){
  ...
  box.innerHTML=`<main class="auth-screen"><section class="auth-shell">
    <div class="auth-identity">
      <img class="auth-laurel" src="auth-laurel-realistic-v1204.png" alt="" aria-hidden="true">
...
async function generateProgramImage(){
 ...
 const assets={};
 const files=['auth-laurel-realistic-v1204.png','anatomy-statue-v1204.png'];
 ...
 const laurel=assets['auth-laurel-realistic-v1204.png'];if(laurel)g.drawImage(laurel,W/2-56,28,112,88);
 ...
 function drawAnatomy(keys,x,y,w,h){
   // v1.20.4 — atlas maître : statue ET zones utilisent le même repère natif 808×948.
   const active=new Set(keys), statue=assets['anatomy-statue-v1204.png'];
   if(!statue)return;
   const SW=808,SH=948,GOLD='#d7aa4f',EDGE='#f4d27f';
   const sc=Math.min(w/SW,h/SH),dw=SW*sc,dh=SH*sc,ox=x+(w-dw)/2,oy=y+(h-dh)/2;
   g.save();g.imageSmoothingEnabled=true;g.imageSmoothingQuality='high';g.drawImage(statue,ox,oy,dw,dh);
   const poly=(pts)=>{g.beginPath();pts.forEach(([px,py],i)=>i?g.lineTo(ox+px*sc,oy+py*sc):g.moveTo(ox+px*sc,oy+py*sc));g.closePath();g.fillStyle=GOLD;g.globalAlpha=.78;g.fill();g.globalAlpha=1;g.strokeStyle=EDGE;g.lineWidth=Math.max(.6,1.2*sc);g.stroke()};
   const ellipse=(cx,cy,rx,ry,rot=0)=>{g.beginPath();g.ellipse(ox+cx*sc,oy+cy*sc,rx*sc,ry*sc,rot,0,Math.PI*2);g.fillStyle=GOLD;g.globalAlpha=.78;g.fill();g.globalAlpha=1;g.strokeStyle=EDGE;g.lineWidth=Math.max(.6,1.2*sc);g.stroke()};
   const P=(k,...shapes)=>{if(active.has(k))shapes.forEach(s=>s[0]==='e'?ellipse(...s.slice(1)):poly(s))};
   // FRONT — coordonnées tracées directement sur anatomy-statue-v1204.png.
   P('cou',[[178,145],[207,130],[238,145],[249,190],[224,211],[193,190]],[[559,146],[590,130],[620,148],[614,194],[589,211],[565,192]]);
   P('pectoraux',[[108,220],[157,191],[216,199],[219,274],[172,292],[120,269]],[[220,199],[276,190],[324,221],[312,270],[262,291],[221,274]]);
   P('deltoide_anterieur',[[92,208],[118,189],[146,193],[137,242],[107,256],[87,237]],[[335,208],[309,190],[281,194],[291,242],[321,257],[341,237]]);
   P('deltoide_lateral',[[79,214],[98,188],[127,188],[117,261],[88,276],[71,249]],[[350,214],[331,188],[302,188],[312,261],[341,276],[358,249]]);
   P('biceps',['e',84,319,20,55,-.08],['e',347,319,20,55,.08]);
   P('triceps',['e',520,323,18,57,.05],['e',745,323,18,57,-.05]);
   P('avant_bras',[[52,365],[88,360],[77,475],[54,525],[36,494]],[[377,365],[341,360],[352,475],[375,525],[393,494]],[[490,365],[526,360],[516,475],[493,525],[475,494]],[[775,365],[739,360],[750,475],[773,525],[791,494]]);
   P('abdominaux',[[167,286],[214,282],[214,446],[169,444],[151,382]],[[216,282],[261,286],[278,382],[260,444],[217,446]]);
   P('adducteurs',[[177,520],[214,522],[207,684],[179,660],[160,574]],[[219,522],[256,520],[273,574],[254,660],[226,684]]);
   P('quadriceps',[[126,520],[176,520],[174,682],[137,702],[112,626]],[[257,520],[307,520],[321,626],[296,702],[259,682]]);
   P('mollets',[[126,692],[173,690],[163,842],[132,860],[112,795]],[[260,690],[307,692],[321,795],[301,860],[270,842]],[[525,699],[572,697],[562,840],[532,858],[511,795]],[[666,697],[713,699],[727,795],[706,858],[676,840]]);
   // BACK.
   P('deltoide_posterieur',[[468,210],[497,188],[529,192],[519,260],[490,274],[463,247]],[[758,210],[729,188],[697,192],[707,260],[736,274],[763,247]]);
   P('deltoide_lateral',[[456,216],[475,190],[503,190],[493,260],[468,275],[451,250]],[[770,216],[751,190],[723,190],[733,260],[758,275],[775,250]]);
   P('trapezes_superieurs',[[542,167],[589,132],[636,168],[682,212],[635,246],[589,220],[543,246],[497,212]]);
   P('trapezes_moyens',[[506,235],[589,221],[589,316],[526,303],[491,269]],[[672,235],[589,221],[589,316],[652,303],[687,269]]);
   P('dos',[[500,282],[572,312],[559,455],[520,481],[486,398]],[[678,282],[606,312],[619,455],[658,481],[692,398]]);
   P('lombaires',[[548,430],[587,411],[587,522],[544,500],[529,467]],[[630,430],[591,411],[591,522],[634,500],[649,467]]);
   P('fessiers',['e',552,556,48,48,-.08],['e',626,556,48,48,.08]);
   P('ischios',[[514,598],[579,598],[567,711],[530,730],[506,655]],[[664,598],[599,598],[611,711],[648,730],[672,655]]);
   g.restore();
 }
...
function trackingMuscuSummary(){
  ...
  return `<section class="track-muscu-recap story-recap ${complete?'week-complete':''}">
    <div class="story-forgelab-brand"><img src="auth-laurel-realistic-v1204.png" alt=""><strong>ForgeLab</strong></div>
...
/* ===== ForgeLab v1.20.4 — Brouillon structuré : Programme > Trame > Blocs > Génération ===== */
