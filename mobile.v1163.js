...
function showAuth(message=''){
  ...
  box.innerHTML=`<main class="auth-screen"><section class="auth-shell">
    <div class="auth-identity">
      <img class="auth-laurel" src="auth-laurel-realistic-v1163.png" alt="" aria-hidden="true">
...
async function generateProgramImage(){
 ...
 let ref=null,laurel=null,footerScene=null,posterRef=null;try{ref=await load('template-reference-v1163.png')}catch(_){ }try{laurel=await load('auth-laurel-realistic-v1163.png')}catch(_){ }try{footerScene=await load('footer-mountains-man-v1163.png')}catch(_){ }try{posterRef=await load('poster-reference-v1163.png')}catch(_){ }
 const atlasFiles={pectoraux:'atlas-pectoraux-v1163.png',dos:'atlas-dos-v1163.png',deltoide_anterieur:'atlas-deltoide_anterieur-v1163.png',deltoide_lateral:'atlas-deltoide_lateral-v1163.png',deltoide_posterieur:'atlas-deltoide_posterieur-v1163.png',trapezes_superieurs:'atlas-trapezes_superieurs-v1163.png',trapezes_moyens:'atlas-trapezes_moyens-v1163.png',cou:'atlas-cou-v1163.png',biceps:'atlas-biceps-v1163.png',triceps:'atlas-triceps-v1163.png',avant_bras:'atlas-avant_bras-v1163.png',abdominaux:'atlas-abdominaux-v1163.png',lombaires:'atlas-lombaires-v1163.png',fessiers:'atlas-fessiers-v1163.png',adducteurs:'atlas-adducteurs-v1163.png',quadriceps:'atlas-quadriceps-v1163.png',ischios:'atlas-ischios-v1163.png',mollets:'atlas-mollets-v1163.png'};
 ...
 // Header v1.16.3 : zone entièrement reconstruite pour supprimer tout élément fantôme du template.
 ...
 // v1.16.3 — composition éditoriale ForgeLab : pas d'icônes UI, pas de cartes.
 ...
 const anatomy=(cx,cy,names,accent)=>{
   const keys=names.map(atlasKey).filter(Boolean),key=keys[0],im=key&&atlasImgs[key];
   if(!im)return;
   const iw=im.naturalWidth||im.width,ih=im.naturalHeight||im.height,maxW=116,maxH=176,scale=Math.min(maxW/iw,maxH/ih),dw=iw*scale,dh=ih*scale;
   g.save();g.globalAlpha=1;g.drawImage(im,cx-dw/2,cy-dh/2,dw,dh);g.restore();
 };
 ...
 // Footer v1.16.3 : scène continue + signature DAILY WINS. dans le ciel.
...
function trackingMuscuSummary(){
  ...
  return `<section class="track-muscu-recap story-recap ${complete?'week-complete':''}">
    <div class="story-forgelab-brand"><img src="auth-laurel-realistic-v1163.png" alt=""><strong>ForgeLab</strong></div>
...
/* ===== ForgeLab v1.16.3 — Programme complet / multi-blocs ===== */
