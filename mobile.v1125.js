...
function drawProgramming(){
  ...
  v.innerHTML=title('Programmation des séances')+
   `<section class="program-workspace program-workspace-clear">
      ...
      <article class="program-status-card draft ${mode==='draft'?'current':''}">
        <div><small>PROCHAIN PROGRAMME</small><strong>${hasDraft?'Brouillon en préparation':'Aucun brouillon'}</strong><span>${hasDraft?'Modifiable sans toucher au programme actif':'Prépare ton prochain bloc séparément'}</span></div>
