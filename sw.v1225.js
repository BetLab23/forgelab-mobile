const CACHE='forgelab-shell-v1237';
const ASSETS=['./','./index.html','./mobile.v1225.css?build=1237','./mobile.v1225.js?build=1224','./manifest.v1225.webmanifest?build=1224','./auth-laurel-realistic-v1225.png?build=1224'];
