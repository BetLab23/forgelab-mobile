const CACHE='forgelab-shell-v1226';
const ASSETS=['./','./index.html','./mobile.v1226.css?build=1224','./mobile.v1226.js?build=1224','./manifest.v1226.webmanifest?build=1224','./auth-laurel-realistic-v1226.png?build=1224'];
