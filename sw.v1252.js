const CACHE='forgelab-shell-v1252';
const ASSETS=['./','./index.html','./mobile.v1225.css?build=1252','./mobile.v1252.js?build=1252','./manifest.v1225.webmanifest?build=1252','./auth-laurel-realistic-v1225.png?build=1252'];
