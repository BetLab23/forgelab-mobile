...
function importPcProgrammingV165(){
  ...
  const marker=`forgelabMobileProgrammingImport:v1105:${currentUser.id}`;
...
function jSeriesBaselineForDraft(id){
  ...
  // Compatibilité immédiate avec les séances déjà validées avant v1.10.5 :
...
function showAuth(message=''){
  ...
  box.innerHTML=`<main class="auth-screen"><section class="auth-shell">
    <div class="auth-identity">
      <img class="auth-laurel" src="auth-laurel-realistic-v1105.png" alt="" aria-hidden="true">
      <div class="auth-brand">FORGELAB</div>
      <div class="auth-sub">ATLAS · ESPACE PERSONNEL</div>
      <div class="auth-version"><span>v1.10.5</span></div>
    </div>
...
function drawTracking(){
  ...
  `<section class="tracking-hero">
    <div class="tracking-hero-copy"><small>FORGELAB · S${state.week}</small><p>Vue d’ensemble de ta charge hebdomadaire.</p></div>
