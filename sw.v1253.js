const CACHE='forgelab-shell-v1253';
const ASSETS=['./','./index.html','./mobile.v1225.css?build=1253','./mobile.v1253.js?build=1253','./manifest.v1225.webmanifest?build=1253','./auth-laurel-realistic-v1225.png?build=1253'];
