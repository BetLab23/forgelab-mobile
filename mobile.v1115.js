...
function importPcProgrammingV165(){
  ...
  const marker=`forgelabMobileProgrammingImport:v1115:${currentUser.id}`;
...
async function repairSeriesFromCarnet(cloudRows){
  // v1.11.5 : fonction conservée uniquement pour compatibilité interne.
...
function jSeriesBaselineForDraft(id){
  ...
  // Compatibilité immédiate avec les séances déjà validées avant v1.11.5 :
...
function showAuth(message=''){
  ...
  box.innerHTML=`<main class="auth-screen"><section class="auth-shell">
    <div class="auth-identity">
      <img class="auth-laurel" src="auth-laurel-realistic-v1115.png" alt="" aria-hidden="true">
      <div class="auth-brand">FORGELAB</div>
      <div class="auth-sub">ATLAS · ESPACE PERSONNEL</div>
      <div class="auth-version"><span>v1.11.5</span></div>
    </div>
...
// v1.11.5 : aucun nettoyage automatique de Séries.
