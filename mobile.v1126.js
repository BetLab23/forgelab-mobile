...
function generateProgramImage(){
 ...
 const a=document.createElement('a');a.download=`ForgeLab_${String(meta.name||'programme').replace(/[^a-z0-9]+/gi,'_')}.png`;a.href=c.toDataURL('image/png');a.click();
}
