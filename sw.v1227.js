const CACHE='forgelab-shell-v1227';
const ASSETS=['./','./index.html','./mobile.v1227.css?build=1224','./mobile.v1227.js?build=1224','./manifest.v1227.webmanifest?build=1224','./auth-laurel-realistic-v1227.png?build=1224'];
