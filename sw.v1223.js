const CACHE='forgelab-shell-v1223';
const ASSETS=['./','./index.html','./mobile.v1223.css?build=1223','./mobile.v1223.js?build=1223','./manifest.v1223.webmanifest?build=1223','./auth-laurel-realistic-v1223.png?build=1223'];
