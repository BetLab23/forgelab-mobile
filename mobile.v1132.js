...
function showAuth(message=''){
  ...
  box.innerHTML=`<main class="auth-screen"><section class="auth-shell">
    <div class="auth-identity">
      <img class="auth-laurel" src="auth-laurel-realistic-v1132.png" alt="" aria-hidden="true">
...
async function generateProgramImage(){
 ...
 let ref=null,laurel=null;try{ref=await load('template-reference-v1132.png')}catch(_){ }try{laurel=await load('auth-laurel-realistic-v1132.png')}catch(_){ }
 ...
 box(315,1240,685,155,'rgba(3,8,12,.72)');txt('PLUS QU’UN PROGRAMME',350,1292,18,white,900);txt('UN PROCESSUS.',350,1320,18,white,900);line(350,1347,430,1347,blue,4);box(620,1250,365,125,'rgba(3,8,12,.78)');txt('DAILY WINS.',802,1312,30,white,700,'center','Georgia');
...
function trackingMuscuSummary(){
  ...
  return `<section class="track-muscu-recap story-recap ${complete?'week-complete':''}">
    <div class="story-forgelab-brand"><img src="auth-laurel-realistic-v1132.png" alt=""><strong>ForgeLab</strong></div>
