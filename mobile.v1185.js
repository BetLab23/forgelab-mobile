...
function showAuth(message=''){
  ...
  box.innerHTML=`<main class="auth-screen"><section class="auth-shell">
    <div class="auth-identity">
      <img class="auth-laurel" src="auth-laurel-realistic-v1185.png" alt="" aria-hidden="true">
...
async function generateProgramImage(){
 ...
 let ref=null,laurel=null,footerScene=null,posterRef=null;try{ref=await load('template-reference-v1185.png')}catch(_){ }try{laurel=await load('auth-laurel-realistic-v1185.png')}catch(_){ }try{footerScene=await load('footer-mountains-man-v1185.png')}catch(_){ }try{posterRef=await load('poster-reference-v1185.png')}catch(_){ }
 const atlasFiles={pectoraux:'atlas-pectoraux-v1185.png',dos:'atlas-dos-v1185.png',deltoide_anterieur:'atlas-deltoide_anterieur-v1185.png',deltoide_lateral:'atlas-deltoide_lateral-v1185.png',deltoide_posterieur:'atlas-deltoide_posterieur-v1185.png',trapezes_superieurs:'atlas-trapezes_superieurs-v1185.png',trapezes_moyens:'atlas-trapezes_moyens-v1185.png',cou:'atlas-cou-v1185.png',biceps:'atlas-biceps-v1185.png',triceps:'atlas-triceps-v1185.png',avant_bras:'atlas-avant_bras-v1185.png',abdominaux:'atlas-abdominaux-v1185.png',lombaires:'atlas-lombaires-v1185.png',fessiers:'atlas-fessiers-v1185.png',adducteurs:'atlas-adducteurs-v1185.png',quadriceps:'atlas-quadriceps-v1185.png',ischios:'atlas-ischios-v1185.png',mollets:'atlas-mollets-v1185.png'};
...
function trackingMuscuSummary(){
  ...
  return `<section class="track-muscu-recap story-recap ${complete?'week-complete':''}">
    <div class="story-forgelab-brand"><img src="auth-laurel-realistic-v1185.png" alt=""><strong>ForgeLab</strong></div>
...
/* ===== ForgeLab v1.18.5 — Brouillon structuré : Programme > Trame > Blocs > Génération ===== */
