...
function showAuth(message=''){
  ...
  box.innerHTML=`<main class="auth-screen"><section class="auth-shell">
    <div class="auth-identity">
      <img class="auth-laurel" src="auth-laurel-realistic-v1203.png" alt="" aria-hidden="true">
...
async function generateProgramImage(){
 ...
 const assets={};
 const files=['auth-laurel-realistic-v1203.png','anatomy-statue-v1203.png'];
 ...
 const laurel=assets['auth-laurel-realistic-v1203.png'];if(laurel)g.drawImage(laurel,W/2-56,28,112,88);
 ...
 function drawAnatomy(keys,x,y,w,h){
   // v1.20.3 — atlas maître : statue ET zones utilisent le même repère natif 808×948.
   const active=new Set(keys), statue=assets['anatomy-statue-v1203.png'];
   if(!statue)return;
   ...
   // FRONT — coordonnées tracées directement sur anatomy-statue-v1203.png.
...
function trackingMuscuSummary(){
  ...
  return `<section class="track-muscu-recap story-recap ${complete?'week-complete':''}">
    <div class="story-forgelab-brand"><img src="auth-laurel-realistic-v1203.png" alt=""><strong>ForgeLab</strong></div>
...
/* ===== ForgeLab v1.20.3 — Brouillon structuré : Programme > Trame > Blocs > Génération ===== */
