const CACHE='forgelab-shell-v1224';
const ASSETS=['./','./index.html','./mobile.v1224.css?build=1224','./mobile.v1224.js?build=1224','./manifest.v1224.webmanifest?build=1224','./auth-laurel-realistic-v1224.png?build=1224'];
