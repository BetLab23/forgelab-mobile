...
function showAuth(message=''){
  ...
  box.innerHTML=`<main class="auth-screen"><section class="auth-shell">
    <div class="auth-identity">
      <img class="auth-laurel" src="auth-laurel-realistic-v1166.png" alt="" aria-hidden="true">
...
async function generateProgramImage(){
 ...
 let ref=null,laurel=null,footerScene=null,posterRef=null;try{ref=await load('template-reference-v1166.png')}catch(_){ }try{laurel=await load('auth-laurel-realistic-v1166.png')}catch(_){ }try{footerScene=await load('footer-mountains-man-v1166.png')}catch(_){ }try{posterRef=await load('poster-reference-v1166.png')}catch(_){ }
 const atlasFiles={pectoraux:'atlas-pectoraux-v1166.png',dos:'atlas-dos-v1166.png',deltoide_anterieur:'atlas-deltoide_anterieur-v1166.png',deltoide_lateral:'atlas-deltoide_lateral-v1166.png',deltoide_posterieur:'atlas-deltoide_posterieur-v1166.png',trapezes_superieurs:'atlas-trapezes_superieurs-v1166.png',trapezes_moyens:'atlas-trapezes_moyens-v1166.png',cou:'atlas-cou-v1166.png',biceps:'atlas-biceps-v1166.png',triceps:'atlas-triceps-v1166.png',avant_bras:'atlas-avant_bras-v1166.png',abdominaux:'atlas-abdominaux-v1166.png',lombaires:'atlas-lombaires-v1166.png',fessiers:'atlas-fessiers-v1166.png',adducteurs:'atlas-adducteurs-v1166.png',quadriceps:'atlas-quadriceps-v1166.png',ischios:'atlas-ischios-v1166.png',mollets:'atlas-mollets-v1166.png'};
 const atlasImgs={};await Promise.all(Object.entries(atlasFiles).map(async([k,f])=>{try{atlasImgs[k]=await load(f)}catch(_){}}));
 // v1.16.6 — anatomie composite : une seule silhouette + calques musculaires superposables.
 let anatomyBase=null;try{anatomyBase=await load('anatomy-base-v1166.png')}catch(_){ }
 const maskFiles=Object.fromEntries(Object.keys(atlasFiles).map(k=>[k,`mask-${k}-v1166.png`]));
 ...
 // Header v1.16.6 : zone entièrement reconstruite pour supprimer tout élément fantôme du template.
 ...
 // v1.16.6 — composition éditoriale ForgeLab : pas d'icônes UI, pas de cartes.
 ...
 const anatomy=(cx,cy,names,accent)=>{
   // v1.16.6 : UNE seule anatomie par séance. Tous les muscles sélectionnés
 ...
 // Footer v1.16.6 : scène continue + signature DAILY WINS. dans le ciel.
...
function trackingMuscuSummary(){
  ...
  return `<section class="track-muscu-recap story-recap ${complete?'week-complete':''}">
    <div class="story-forgelab-brand"><img src="auth-laurel-realistic-v1166.png" alt=""><strong>ForgeLab</strong></div>
...
/* ===== ForgeLab v1.16.6 — Programme complet / multi-blocs ===== */
