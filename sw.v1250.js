const CACHE='forgelab-shell-v1250';
const ASSETS=['./','./index.html','./mobile.v1225.css?build=1250','./mobile.v1250.js?build=1250','./manifest.v1225.webmanifest?build=1250','./auth-laurel-realistic-v1225.png?build=1250'];
