...
function importPcProgrammingV165(){
  ...
  const marker=`forgelabMobileProgrammingImport:v175:${currentUser.id}`;
...
function showAuth(message=''){
  ...
  box.innerHTML=`<main class="auth-screen"><section class="auth-shell">
    <div class="auth-identity">
      <img class="auth-laurel" src="auth-laurel-realistic-v175.png" alt="" aria-hidden="true">
      <div class="auth-brand">FORGELAB</div>
      <div class="auth-sub">ATLAS · ESPACE PERSONNEL</div>
      <div class="auth-version"><span>v1.7.5</span></div>
    </div>
...
(function(){
  ...
  setTimeout(()=>{try{splash.remove()}catch(_){}},4525);
})();
