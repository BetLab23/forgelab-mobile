...
function showAuth(message=''){
  ...
  box.innerHTML=`<main class="auth-screen"><section class="auth-shell">
    <div class="auth-identity">
      <img class="auth-laurel" src="auth-laurel-realistic-v1178.png" alt="" aria-hidden="true">
...
async function generateProgramImage(){
 ...
 let ref=null,laurel=null,footerScene=null,posterRef=null;try{ref=await load('template-reference-v1178.png')}catch(_){ }try{laurel=await load('auth-laurel-realistic-v1178.png')}catch(_){ }try{footerScene=await load('footer-mountains-man-v1178.png')}catch(_){ }try{posterRef=await load('poster-reference-v1178.png')}catch(_){ }
 const atlasFiles={pectoraux:'atlas-pectoraux-v1178.png',dos:'atlas-dos-v1178.png',deltoide_anterieur:'atlas-deltoide_anterieur-v1178.png',deltoide_lateral:'atlas-deltoide_lateral-v1178.png',deltoide_posterieur:'atlas-deltoide_posterieur-v1178.png',trapezes_superieurs:'atlas-trapezes_superieurs-v1178.png',trapezes_moyens:'atlas-trapezes_moyens-v1178.png',cou:'atlas-cou-v1178.png',biceps:'atlas-biceps-v1178.png',triceps:'atlas-triceps-v1178.png',avant_bras:'atlas-avant_bras-v1178.png',abdominaux:'atlas-abdominaux-v1178.png',lombaires:'atlas-lombaires-v1178.png',fessiers:'atlas-fessiers-v1178.png',adducteurs:'atlas-adducteurs-v1178.png',quadriceps:'atlas-quadriceps-v1178.png',ischios:'atlas-ischios-v1178.png',mollets:'atlas-mollets-v1178.png'};
...
function trackingMuscuSummary(){
  ...
  return `<section class="track-muscu-recap story-recap ${complete?'week-complete':''}">
    <div class="story-forgelab-brand"><img src="auth-laurel-realistic-v1178.png" alt=""><strong>ForgeLab</strong></div>
...
/* ===== ForgeLab v1.17.8 — Brouillon structuré : Programme > Trame > Blocs > Génération ===== */
...
drawProgramming=function(){
  ...
  if(!programBlockOpen){dailyNodes.forEach(n=>n.remove());v.appendChild(generation)}else if(dailyNodes.length){const last=dailyNodes[dailyNodes.length-1];last.insertAdjacentElement('afterend',generation)}else v.appendChild(generation);
