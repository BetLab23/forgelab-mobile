...
function showAuth(message=''){
  ...
  box.innerHTML=`<main class="auth-screen"><section class="auth-shell">
    <div class="auth-identity">
      <img class="auth-laurel" src="auth-laurel-realistic-v1182.png" alt="" aria-hidden="true">
...
function draw(){
  ...
  if(weekDots) weekDots.hidden=state.tab==='priorities';
...
async function generateProgramImage(){
 ...
 let ref=null,laurel=null,footerScene=null,posterRef=null;try{ref=await load('template-reference-v1182.png')}catch(_){ }try{laurel=await load('auth-laurel-realistic-v1182.png')}catch(_){ }try{footerScene=await load('footer-mountains-man-v1182.png')}catch(_){ }try{posterRef=await load('poster-reference-v1182.png')}catch(_){ }
 const atlasFiles={pectoraux:'atlas-pectoraux-v1182.png',dos:'atlas-dos-v1182.png',deltoide_anterieur:'atlas-deltoide_anterieur-v1182.png',deltoide_lateral:'atlas-deltoide_lateral-v1182.png',deltoide_posterieur:'atlas-deltoide_posterieur-v1182.png',trapezes_superieurs:'atlas-trapezes_superieurs-v1182.png',trapezes_moyens:'atlas-trapezes_moyens-v1182.png',cou:'atlas-cou-v1182.png',biceps:'atlas-biceps-v1182.png',triceps:'atlas-triceps-v1182.png',avant_bras:'atlas-avant_bras-v1182.png',abdominaux:'atlas-abdominaux-v1182.png',lombaires:'atlas-lombaires-v1182.png',fessiers:'atlas-fessiers-v1182.png',adducteurs:'atlas-adducteurs-v1182.png',quadriceps:'atlas-quadriceps-v1182.png',ischios:'atlas-ischios-v1182.png',mollets:'atlas-mollets-v1182.png'};
...
function trackingMuscuSummary(){
  ...
  return `<section class="track-muscu-recap story-recap ${complete?'week-complete':''}">
    <div class="story-forgelab-brand"><img src="auth-laurel-realistic-v1182.png" alt=""><strong>ForgeLab</strong></div>
...
/* ===== ForgeLab v1.18.2 — Brouillon structuré : Programme > Trame > Blocs > Génération ===== */
