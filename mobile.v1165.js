...
function showAuth(message=''){
  ...
  box.innerHTML=`<main class="auth-screen"><section class="auth-shell">
    <div class="auth-identity">
      <img class="auth-laurel" src="auth-laurel-realistic-v1165.png" alt="" aria-hidden="true">
...
async function generateProgramImage(){
 ...
 let ref=null,laurel=null,footerScene=null,posterRef=null;try{ref=await load('template-reference-v1165.png')}catch(_){ }try{laurel=await load('auth-laurel-realistic-v1165.png')}catch(_){ }try{footerScene=await load('footer-mountains-man-v1165.png')}catch(_){ }try{posterRef=await load('poster-reference-v1165.png')}catch(_){ }
 const atlasFiles={pectoraux:'atlas-pectoraux-v1165.png',dos:'atlas-dos-v1165.png',deltoide_anterieur:'atlas-deltoide_anterieur-v1165.png',deltoide_lateral:'atlas-deltoide_lateral-v1165.png',deltoide_posterieur:'atlas-deltoide_posterieur-v1165.png',trapezes_superieurs:'atlas-trapezes_superieurs-v1165.png',trapezes_moyens:'atlas-trapezes_moyens-v1165.png',cou:'atlas-cou-v1165.png',biceps:'atlas-biceps-v1165.png',triceps:'atlas-triceps-v1165.png',avant_bras:'atlas-avant_bras-v1165.png',abdominaux:'atlas-abdominaux-v1165.png',lombaires:'atlas-lombaires-v1165.png',fessiers:'atlas-fessiers-v1165.png',adducteurs:'atlas-adducteurs-v1165.png',quadriceps:'atlas-quadriceps-v1165.png',ischios:'atlas-ischios-v1165.png',mollets:'atlas-mollets-v1165.png'};
 ...
 // Header v1.16.5 : zone entièrement reconstruite pour supprimer tout élément fantôme du template.
 ...
 // v1.16.5 — composition éditoriale ForgeLab : pas d'icônes UI, pas de cartes.
 ...
 const anatomy=(cx,cy,names,accent)=>{
   // v1.16.5: afficher TOUS les groupes travaillés, au lieu du seul premier groupe.
 ...
 // Footer v1.16.5 : scène continue + signature DAILY WINS. dans le ciel.
...
function trackingMuscuSummary(){
  ...
  return `<section class="track-muscu-recap story-recap ${complete?'week-complete':''}">
    <div class="story-forgelab-brand"><img src="auth-laurel-realistic-v1165.png" alt=""><strong>ForgeLab</strong></div>
...
/* ===== ForgeLab v1.16.5 — Programme complet / multi-blocs ===== */
