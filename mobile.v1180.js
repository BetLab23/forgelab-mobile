...
function showAuth(message=''){
  ...
  box.innerHTML=`<main class="auth-screen"><section class="auth-shell">
    <div class="auth-identity">
      <img class="auth-laurel" src="auth-laurel-realistic-v1180.png" alt="" aria-hidden="true">
...
async function generateProgramImage(){
 ...
 let ref=null,laurel=null,footerScene=null,posterRef=null;try{ref=await load('template-reference-v1180.png')}catch(_){ }try{laurel=await load('auth-laurel-realistic-v1180.png')}catch(_){ }try{footerScene=await load('footer-mountains-man-v1180.png')}catch(_){ }try{posterRef=await load('poster-reference-v1180.png')}catch(_){ }
 const atlasFiles={pectoraux:'atlas-pectoraux-v1180.png',dos:'atlas-dos-v1180.png',deltoide_anterieur:'atlas-deltoide_anterieur-v1180.png',deltoide_lateral:'atlas-deltoide_lateral-v1180.png',deltoide_posterieur:'atlas-deltoide_posterieur-v1180.png',trapezes_superieurs:'atlas-trapezes_superieurs-v1180.png',trapezes_moyens:'atlas-trapezes_moyens-v1180.png',cou:'atlas-cou-v1180.png',biceps:'atlas-biceps-v1180.png',triceps:'atlas-triceps-v1180.png',avant_bras:'atlas-avant_bras-v1180.png',abdominaux:'atlas-abdominaux-v1180.png',lombaires:'atlas-lombaires-v1180.png',fessiers:'atlas-fessiers-v1180.png',adducteurs:'atlas-adducteurs-v1180.png',quadriceps:'atlas-quadriceps-v1180.png',ischios:'atlas-ischios-v1180.png',mollets:'atlas-mollets-v1180.png'};
...
function trackingMuscuSummary(){
  ...
  return `<section class="track-muscu-recap story-recap ${complete?'week-complete':''}">
    <div class="story-forgelab-brand"><img src="auth-laurel-realistic-v1180.png" alt=""><strong>ForgeLab</strong></div>
...
/* ===== ForgeLab v1.18.0 — Brouillon structuré : Programme > Trame > Blocs > Génération ===== */
